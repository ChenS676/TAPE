...
def pairwise_prediction(data, test_index):
    ...
    test_pred = torch.tensor(np.asarray([t.cpu().numpy() for t in test_pred]))
...
if __name__ == '__main__':
    ...
    for name in ['history', 'photo']:#'pwc_small', 'cora', 'pubmed', 'arxiv_2023', 'pwc_medium', 'ogbn-arxiv', 'citationv8']:  
