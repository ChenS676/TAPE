...
from model import BertClassifier, BertClaInfModel,NCNClaInfModel,NCNClassifier,GCNClassifier,GCNClaInfModel, Co_LMGCN,Co_LMGCNInf
...
class LMTrainer():
    def __init__(self, cfg):
        ...
        if self.decoder.model.type == 'MLP':
            ...
            self.model = Co_LMGCN(bert_model, cfg, create_GAE_model(cfg_model, cfg_score, args.model), adj_t=self.adj_t, classifier=None).to(self.device)
