#!/usr/bin/env bash
# LINK=https://drive.google.com/file/d/15ZWzRESVpNFowt3zfm3v8-5DGdnMjFzk/view?usp=sharing
# gdown https://drive.google.com/file/d/15ZWzRESVpNFowt3zfm3v8-5DGdnMjFzk/view?usp=drive_link for manual download
...
# 5. run this script
# 6. gdown $google link (https://drive.usercontent.google.com/download?id=1RMzPPqsHOQK8JBF1yEQOLzeg1G_rb0uw&export=download&authuser=0)
